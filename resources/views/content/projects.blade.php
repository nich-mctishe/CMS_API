<section class="content projects">
    @if (Auth::check())
        ...
        <form name="newProjectForm" data-ng-class="(newProject) ? 'active' : 'disabled'" enctype="multipart/form-data"
            ...
            <input data-ng-show="editProjectSelected" type="submit" value="Save"/>
        </form>
    @endif
                ...
                <form name="updateProjectForm" class="active" data-ng-submit="update($index, updateProjectForm, this)">
                    <ul class="toolbar">
                        <li tooltip="change image">
                            <div flow-init="{target: '/{{ $pageType }}/images/' + project.id + '/' + project.images[0].id}" flow-name="files.images[0].flow">
                                <span flow-btn tooltip="Change Image">&plus;&nbsp;&nbsp;I</span>
                            </div>
                        </li>
                        <li data-ng-click="deleteImage(project.id, project.images[0].id, $index, 0)" tooltip="Delete Image">&#8998;&nbsp;&nbsp;I</li>
                    ...
                    <section class="read-more" data-ng-class="(readMoreSelected) ? 'active' : 'disabled'">
                        ...
                        <ul class="toolbar">
                            <li class="two" tooltip="change image">
                                <div flow-init="{target: '/{{ $pageType }}/images/' + project.id + '/' + project.images[1].id}" flow-name="files.images[1].flow">
                                    <span flow-btn tooltip="Change Image">&plus;&nbsp;&nbsp;I</span>
                                </div>
                            </li>
                            <li class="two" data-ng-click="deleteImage(project.id, project.images[1].id, $index, 1)" tooltip="Delete Image">&#8998;&nbsp;&nbsp;I</li>
                        </ul>
                        <div class="imgWrapper">
                        ...
                        <ul class="skills" data-ng-if="project.skillTags.length>0" data-ng-hide="editProjectSelected">
                            <li data-ng-repeat="skillTag in project.skillTags">@{{ skillTag.skill.name }},</li>
                        </ul>
