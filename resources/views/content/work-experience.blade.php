...
<section class="content work-experience">
    ...
    <form name="addPreviousEmployer" data-ng-class="(workExperienceFormSelected) ? 'active' : 'disabled'"
        ...
        <div flow-init flow-name="workExperienceFiles.images[0].flow" flow-file-success="uploader.successCallback($flow, $file, $message, 'workExperience')">
            ...
            @if (Auth::check())
                <li data-ng-repeat="employer in previousExperience">
                    <form class="active" name="updatePreviousEmployer" data-ng-submit="workExperience.update($index, updatePreviousEmployer, this)">
                        ...
                        <h3 data-ng-show="!editWorkExperienceSelected">Employment Term: <span class="start" data-ng-bind="employer.dateStarted"></span> -
                            <span class="end" data-ng-bind="employer.dateEnded"></span>
                        </h3>
                ...
                <li data-ng-repeat="employer in previousExperience">
                    ...
                    <h3>Employment Term: <span class="start" data-ng-bind="employer.dateStarted"></span> -
                        <span class="end" data-ng-bind="employer.dateEnded"></span>
                    </h3>
